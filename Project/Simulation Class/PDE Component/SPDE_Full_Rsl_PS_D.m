classdef SPDE_Full_Rsl_PS_D< PS_D
    %ODE Summary of this class goes here
    %   Detailed explanation goes here
    
    properties
        pde_name = 'SPDE_Full_Rsl_PS'
        Noise_Str = 2e-6;
    end
    
    methods
        function S = SPDE_Full_Rsl_PS_D(P)
        ...
        function f = odefun(S,t)
            ...
            dW = S.Noise_Str * randn(S.rand_stream,P.Nx,1)*sqrt(1/(P.Nx*P.dt));
     ...
     - P.klv*DODLlv + P.ksl*(P.delta_rho/P.rhol)*DODLsl;
            f(P.Nx+1:2*P.Nx,1) = (-P.ksl)*DODLsl + dW(:);
        end
